...
Student students[50] = {//学生信息静态初始化
    ...
    {1, "张三", "男", "2004-01-01", 2, "软件工程", "13812345678", 1, -1, -1},
    {2, "李四", "女", "2005-01-19", 1, "软件工程", "13987654321", 2, -1, -1},
    {3, "王五", "男", "2003-03-03", 3, "软件工程", "13600101111", 1, -1, -1},
    {4, "马六", "女", "2002-01-20", 4, "软件工程", "11432101901", 2, -1, -1},
    {5, "黄七", "女", "2005-05-20", 1, "软件工程", "11332101901", 2, -1, -1},
    {6, "张三", "男", "2004-01-01", 2, "软件工程", "13812345678", 1, -1, -1},
    {7, "李四", "女", "2005-01-19", 1, "软件工程", "13987654321", 2, -1, -1},
    {8, "王五", "男", "2003-03-03", 3, "软件工程", "13600001111", 1, -1, -1},
    {9, "马六", "女", "2002-01-20", 4, "软件工程", "11352101901", 2, -1, -1},
    {10, "黄七", "女", "2005-05-20", 1, "软件工程", "12332101901", 2, -1, -1},
    {11, "张三", "男", "2004-01-01", 2, "软件工程", "13812245678", 1, -1, -1},
    {12, "李四", "女", "2005-01-19", 1, "软件工程", "15987654321", 2, -1, -1},
    {13, "王五", "男", "2003-03-03", 3, "软件工程", "13600401111", 1, -1, -1},
    {14, "马六", "女", "2002-01-20", 4, "软件工程", "14332101901", 2, -1, -1},
    {15, "黄七", "女", "2005-05-20", 1, "软件工程", "11332101601", 2, -1, -1},
    {16, "张三", "男", "2004-01-01", 2, "软件工程", "13812345078", 1, -1, -1},
    {17, "李四", "女", "2005-01-19", 1, "软件工程", "13987664321", 2, -1, -1},
    {18, "王五", "男", "2003-03-03", 3, "软件工程", "13620001111", 1, -1, -1},
    {19, "马六", "女", "2002-01-20", 4, "软件工程", "11532101901", 2, -1, -1},
    {20, "黄七", "女", "2005-05-20", 1, "软件工程", "15332101901", 2, -1, -1},
    {21, "张三", "男", "2004-01-01", 2, "软件工程", "13512345678", 1, -1, -1},
    {22, "李四", "女", "2005-01-19", 1, "软件工程", "13987454321", 2, -1, -1},
    {23, "王五", "男", "2003-03-03", 3, "软件工程", "13600091111", 1, -1, -1},
    {24, "马六", "女", "2002-01-20", 4, "软件工程", "11392101901", 2, -1, -1},
    {25, "黄七", "女", "2005-05-20", 1, "软件工程", "11632101901", 2, -1, -1},
    {26, "张三", "男", "2004-01-01", 2, "软件工程", "19812345678", 1, -1, -1},
    {27, "李四", "女", "2005-01-19", 1, "软件工程", "13987654621", 2, -1, -1},
    {28, "王五", "男", "2003-03-03", 3, "软件工程", "13700001111", 1, -1, -1},
    {29, "马六", "女", "2002-01-20", 4, "软件工程", "11732101901", 2, -1, -1},
    {30, "黄七", "女", "2005-05-20", 1, "软件工程", "17332101901", 2, -1, -1},
    {31, "张三", "男", "2004-01-01", 2, "软件工程", "13812345778", 1, -1, -1},
    {32, "李四", "女", "2005-01-19", 1, "软件工程", "13987674321", 2, -1, -1},
    {33, "王五", "男", "2003-03-03", 3, "软件工程", "13670001111", 1, -1, -1},
    {34, "马六", "女", "2002-01-20", 4, "软件工程", "11337101901", 2, -1, -1},
    {35, "黄七", "女", "2005-05-20", 1, "软件工程", "11377101901", 2, -1, -1},
    {36, "张三", "男", "2004-01-01", 2, "软件工程", "13812645678", 1, -1, -1},
    {37, "李四", "女", "2005-01-19", 1, "软件工程", "13967654321", 2, -1, -1},
    {38, "王五", "男", "2003-03-03", 3, "软件工程", "13606001111", 1, -1, -1},
    {39, "马六", "女", "2002-01-20", 4, "软件工程", "11332601901", 2, -1, -1},
    {40, "黄七", "女", "2005-05-20", 1, "软件工程", "11032101901", 2, -1, -1},
    {41, "张三", "男", "2004-01-01", 2, "软件工程", "13814345678", 1, -1, -1},
    {42, "李四", "女", "2005-01-19", 1, "软件工程", "13987754321", 2, -1, -1},
    {43, "王五", "男", "2003-03-03", 3, "软件工程", "13650001111", 1, -1, -1},
    {44, "马六", "女", "2002-01-20", 4, "软件工程", "11882101901", 2, -1, -1},
    {45, "黄七", "女", "2005-05-20", 1, "软件工程", "11392101901", 2, -1, -1},
    {46, "张三", "男", "2004-01-01", 2, "软件工程", "13412345678", 1, -1, -1},
    {47, "李四", "女", "2005-01-19", 1, "软件工程", "13987656321", 2, -1, -1},
    {48, "王五", "男", "2003-03-03", 3, "软件工程", "13607001111", 1, -1, -1},
    {49, "马六", "女", "2002-01-20", 4, "软件工程", "11332801901", 2, -1, -1},
    {50, "黄七", "女", "2005-05-20", 1, "软件工程", "11132101901", 2, -1, -1},
};
...
void student_checkout(int building_number, int dorminary_number, int bed_number)
{
    ...
    for (auto& student : students) {
        ...
        {
            student.building_number = -1;//还原学生的宿舍信息
            student.dormitory_number = -1;
            student.bed_number = -1;
            found = true;
            break;
...
void display_all_students()
{
    ...
    {
        cout << "学号：" << student.student_id << "，姓名：" << student.name << "，性别：" << student.gender << "，出生日期：" << student.birthdate << "，年级：" << student.grade << "，专业：" << student.major << "，宿舍号：" << student.dormitory_number << "，床位号：" << student.bed_number << endl;
    }
}
